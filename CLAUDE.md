...
- Metabolite.transporter_count (int, post-import): distinct **tc_specificity LEAVES** pointing at this metabolite via Tcdb_family_transports_metabolite. The post-import filters `level_kind = 'tc_specificity'` to count actual transporter systems rather than ancestors-via-rollup.
