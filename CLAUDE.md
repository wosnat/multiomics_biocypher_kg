...
- **tcdb_adapter.py** — TCDB transport ontology + substrate→Metabolite bridge + cross-ontology bridges to Pfam and GO. Reads `cache/data/tcdb/{tcdb_hierarchy,tcdb_pruned}.json` built by step 6. Pruned to gene-annotated TC IDs **+ their ancestors only** (no downward walk)
