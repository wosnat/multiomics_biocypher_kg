...
- Nodes: `Gene`, `Protein`, `OrganismTaxon`, `Publication`, `Experiment`, `OrthologGroup`, `BiologicalProcess`, `CellularComponent`, `MolecularFunction`, `EcNumber`, `KeggTerm`, `CogFunctionalCategory`, `CyanorakRole`, `TigrRole`, `Pfam`, `PfamClan`, `TcdbFamily`, `CazyFamily`, `BriteCategory`, `ClusteringAnalysis`, `GeneCluster`, `Reaction`, `Metabolite`, `MetaboliteAssay`
