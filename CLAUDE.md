...
- Metabolite node gains post-import `measured_assay_count`, `measured_organisms` (str[]), `measured_paper_count`. `evidence_sources` may include `"metabolomics"`. `organism_count`/`organism_names` UNION extended to include the measurement path.
