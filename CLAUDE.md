...
- Strains in graph: MED4, AS9601, MIT9301, MIT9312, MIT9313, MIT9303, NATL1A, NATL2A, RSP50, **SS120** (Prochlorococcus); CC9311, WH7803, PCC7002, PCC7942, UTEX2973, **BL107** (Synechococcus); WH8102 (Parasynechococcus); BP1 (Thermosynechococcus); MIT1002, EZ55, HOT1A3, **AltMedDE** (Alteromonas); W3-18-1 (Shewanella); KT2440 (Pseudomonas); DSS-3 (Ruegeria); MruberA (Meiothermus); **HP15** (Marinobacter). New as of 2026-04-15: SS120, BL107, HP15, AltMedDE (added for Domínguez 2017 + Fuszard 2012 + Moreno 2023 integration). AltMedDE + HP15 are currently used as proxy strains for community-fraction proteomics — see `docs/community_proteomics_marref_saga.md`.
...
- Current organisms: 10 *Prochlorococcus* (+SS120) + 7 *Synechococcus/Parasynechococcus/Thermosynechococcus* (+BL107) + 4 *Alteromonas* (+AltMedDE = *A. mediterranea* DE) + 5 heterotrophs (Shewanella, Pseudomonas, Ruegeria, Meiothermus, **Marinobacter adhaerens HP15**); 32 OrganismTaxon nodes total (27 genome strains + 5 treatment organisms); primary focus is MED4 (NCBI taxid 59919)
